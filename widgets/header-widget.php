		...
		<header class="navbar" id="navbar">
			<div class="container nav-container" style="display: flex; align-items: center; justify-content: space-between;">
				<a href="<?php echo esc_url(home_url('/')); ?>" class="logo" style="display: flex; align-items: center;">
					<img src="<?php echo esc_url($settings['logo_white']['url']); ?>" alt="Otic Ear Care" class="logo-white"
						style="height: 55px; width: auto;">
					<img src="<?php echo esc_url($settings['logo_dark']['url']); ?>" alt="Otic Ear Care" class="logo-dark"
						style="height: 55px; width: auto;">
				</a>

				<nav class="nav-links"
					style="display: flex; align-items: center; gap: 2.5rem; margin: 0 auto; padding: 0 1rem;">
					<?php foreach ($menu_items as $item): ?>
						<?php if ($item['has_dropdown']): ?>
							<div class="dropdown">
								<button class="dropbtn"
									style="display: flex; align-items: center; gap: 0.5rem; font-weight: 600; color: inherit; background: none; border: none; cursor: pointer; padding: 0.5rem 0;">
						...
						<?php else: ?>
							<a href="<?php echo esc_url($item['link']); ?>"
								style="font-weight: 600; text-decoration: none; color: inherit; padding: 0.5rem 0;"><?php echo esc_html($item['text']); ?></a>
						<?php endif; ?>
					<?php endforeach; ?>
				</nav>

				<div class="nav-right" style="display: flex; align-items: center; gap: 1.5rem;">
					<a href="<?php echo esc_url($settings['cta_link']['url']); ?>" class="btn btn-primary nav-cta"
						style="padding: 0.8rem 1.8rem; border-radius: 100px; font-weight: 700;">
						<?php echo esc_html($settings['cta_text']); ?> <i class="ph-bold ph-arrow-right"></i>
					</a>
					<button class="menu-toggle" id="mobile-menu-btn"
						style="background: none; border: none; font-size: 2rem; cursor: pointer;"><i
			...
			<div class="mobile-nav" id="mobile-nav">
				<div class="mobile-nav-header">
					<a href="<?php echo esc_url(home_url('/')); ?>" class="mobile-logo">
						<img src="<?php echo esc_url($settings['logo_dark']['url']); ?>" alt="Otic Ear Care"
							style="height: 60px;">
					</a>
				...
				<div class="mobile-nav-body">
					...
					<?php
					$icons = [
						'Ear Wax Removal' => 'ph-fill ph-ear',
						'Ear Treatments' => 'ph-fill ph-microscope',
						'Fees' => 'ph-fill ph-currency-gbp',
						'Insights & Advice' => 'ph ph-lightbulb',
						'Contact' => 'ph-fill ph-phone-call',
					];
					foreach ($menu_items as $item):
						$icon_class = $icons[$item['text']] ?? 'ph ph-lightbulb';
						?>
						<?php if ($item['has_dropdown']): ?>
				...
				<div class="mobile-nav-footer">
					<div class="mobile-contact-box">
						<div class="contact-icon"><i class="ph-fill ph-phone"></i></div>
